...
vendedor.aprovarDesconto(0.02);      // Gerente Aprovar
vendedor.aprovarDesconto(0.09);      // Diretor Aprovar
vendedor.aprovarDesconto(0.03);      // Gerente Aprovar
vendedor.aprovarDesconto(0.20);      // CEO Aprovar
gerente.aprovarDesconto(0.08);
